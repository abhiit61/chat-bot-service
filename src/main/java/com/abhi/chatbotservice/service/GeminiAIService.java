...
public class GeminiAIService {
  ...
  private final String apiModelUrl;

  public GeminiAIService(@Value("${gemini.api.key}") String apiKey, @Value("${gemini.api.baseurl}") String apiBaseUrl,
      @Value("${gemini.api.modelurl}") String apiModelUrl) {
    this.apiKey = apiKey;
    this.apiModelUrl = apiModelUrl;
